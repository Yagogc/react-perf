...
const Cell = React.memo(
  ({
    ...
    return (
      <div
        onClick={() => onClick(rowKey, columnKey)}
...
class Table extends PureComponent {
  ...
  getLatLng = () => {
    return (
      this.state.rows.find(row => row.name === this.state.activeRow) || {}
    ).latlng;
  };
